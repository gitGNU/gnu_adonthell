/*
   ...
   Copyright (C) 2000/2001 Thorsten Riess <thorsten.riess@tu-ilmenau.de>
...
class character_base : public storage
{
 public:
    ...
    /** 
     * Saves the state (attributes) of the %character into an opened file.
     * 
    ...
    void set_inventory(inventory_base * i) { if(inventory) delete inventory; inventory= i; };
    equipment * get_equipment () { return equ; };
    void set_equipment ( equipment * e ) { if ( equ ) delete equ; equ = e; };
