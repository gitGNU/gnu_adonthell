...
create_error_window (error_dlg * dlg)
{
    ...
    gtk_object_set_data_full (GTK_OBJECT (error_window), "vbox1", vbox1, (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (error_window), "scrolledwindow1", scrolledwindow1, (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (error_window), "error_msg", error_msg, (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (error_window), "hseparator1", hseparator1, (GtkDestroyNotify) gtk_widget_unref);
    gtk_widget_show (hseparator1);
    gtk_box_pack_start (GTK_BOX (vbox1), hseparator1, FALSE, TRUE, 2);

    hbuttonbox1 = gtk_hbutton_box_new ();
    gtk_widget_ref (hbuttonbox1);
    gtk_object_set_data_full (GTK_OBJECT (error_window), "hbuttonbox1", hbuttonbox1, (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_object_set_data_full (GTK_OBJECT (error_window), "error_close", error_close, (GtkDestroyNotify) gtk_widget_unref);
    ...
    gtk_signal_connect (GTK_OBJECT (error_close), "clicked", GTK_SIGNAL_FUNC (on_error_close_clicked), dlg);
    gtk_signal_connect (GTK_OBJECT (error_window), "delete_event", GTK_SIGNAL_FUNC (on_error_delete), dlg);
