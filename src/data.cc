...
bool data::load (u_int32 pos)
{
    ...
    characters.set (the_player->get_name().c_str (), the_player);
    ...
    PyDict_SetItemString (chars, (char *) the_player->get_name().c_str (),
                          pass_instance (the_player, "character"));
#endif
...
void data::unload ()
{
    ...
    {
        data::quests.erase (myquest->name.c_str ());
        delete myquest;
    }    
