...
#define  SWIGTYPE_p_Functor0 swig_types[4] 
...
/*-----------------------------------------------
              @(target):= win_basec.so
  ------------------------------------------------*/
#define SWIG_init    initwin_basec

#define SWIG_name    "win_basec"
...
static PyMethodDef win_basecMethods[] = {
...
extern "C" 
#endif
SWIGEXPORT(void) initwin_basec(void) {
    PyObject *m, *d;
    int i;
    SWIG_globals = SWIG_newvarlink();
    m = Py_InitModule("win_basec", win_basecMethods);
