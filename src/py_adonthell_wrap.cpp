...
static int _wrap_screen__trans_set(PyObject *val) {
    ...
    if (PyErr_Occurred()) {
        PyErr_SetString(PyExc_TypeError,"C variable 'screen_trans'(unsigned int )");
        return 1; 
    }
    screen::trans = tval;
    return 0;
...
static int _wrap_screen__trans_pix_set(PyObject *val) {
    ...
    tval = (unsigned int ) PyInt_AsLong(val);
    if (PyErr_Occurred()) {
        PyErr_SetString(PyExc_TypeError,"C variable 'screen_trans_pix'(unsigned int )");
        return 1; 
    }
...
static PyObject *_wrap_mapengine_launch_dialog(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,"OOs:mapengine_launch_dialog",&argo0,&argo1,&arg2)) return NULL;
    if ((SWIG_ConvertPtr(argo0,(void **) &arg0,SWIGTYPE_p_mapengine,1)) == -1) return NULL;
    if ((SWIG_ConvertPtr(argo1,(void **) &arg1,SWIGTYPE_p_character_base,1)) == -1) return NULL;
    arg0->launch_dialog(arg1,arg2);
    Py_INCREF(Py_None);
    resultobj = Py_None;
    return resultobj;
}
...
static PyObject *_wrap_new_dialog_engine(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,"OsO|b:new_dialog_engine",&argo0,&arg1,&argo2,&arg3)) return NULL;
    if ((SWIG_ConvertPtr(argo0,(void **) &arg0,SWIGTYPE_p_character_base,1)) == -1) return NULL;
    if ((SWIG_ConvertPtr(argo2,(void **) &arg2,SWIGTYPE_p_win_theme,1)) == -1) return NULL;
    result = (dialog_engine *)new dialog_engine(arg0,arg1,arg2,arg3);
...
static PyObject *_wrap_dialog_engine_init(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,"OOsO|b:dialog_engine_init",&argo0,&argo1,&arg2,&argo3,&arg4)) return NULL;
    if ((SWIG_ConvertPtr(argo0,(void **) &arg0,SWIGTYPE_p_dialog_engine,1)) == -1) return NULL;
    if ((SWIG_ConvertPtr(argo1,(void **) &arg1,SWIGTYPE_p_character_base,1)) == -1) return NULL;
    if ((SWIG_ConvertPtr(argo3,(void **) &arg3,SWIGTYPE_p_win_theme,1)) == -1) return NULL;
    arg0->init(arg1,arg2,arg3,arg4);
    Py_INCREF(Py_None);
    resultobj = Py_None;
    return resultobj;
}
