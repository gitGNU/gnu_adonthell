...
#define  SWIGTYPE_p_gzFile swig_types[2] 
...
/*-----------------------------------------------
              @(target):= mapcharacterc.so
  ------------------------------------------------*/
#define SWIG_init    initmapcharacterc

#define SWIG_name    "mapcharacterc"
...
static PyObject *_wrap_landmap_add_submap(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,"Ohh:landmap_add_submap",&argo0,&arg1,&arg2)) return NULL;
    if ((SWIG_ConvertPtr(argo0,(void **) &arg0,SWIGTYPE_p_landmap,1)) == -1) return NULL;
    result = (signed char )arg0->add_submap(arg1,arg2);
    resultobj = PyInt_FromLong((long)result);
    return resultobj;
}
...
static PyMethodDef mapcharactercMethods[] = {
...
extern "C" 
#endif
SWIGEXPORT(void) initmapcharacterc(void) {
    PyObject *m, *d;
    int i;
    SWIG_globals = SWIG_newvarlink();
    m = Py_InitModule("mapcharacterc", mapcharactercMethods);
