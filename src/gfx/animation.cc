...
s_int8 animation::load (const std::string fname)
{
...
s_int8 animation::save (const std::string fname) const
{
...
{
    std::vector <image *>::iterator i;
    std::vector <animationframe>::iterator j;
...
{
    std::vector <animationframe>::iterator i;
...
{ 
    ...
    // Copy images
    std::vector <image *>::iterator imit; 
    ...
    // Copy frames
    std::vector <animationframe>::iterator frit; 
