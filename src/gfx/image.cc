...
s_int8 image::load (std::string fname)
{
...
s_int8 image::load_raw (std::string fname)
{
    igzstream file (fname);
    s_int8 ret = 0; 
...
s_int8 image::load_pnm (std::string fname)
{
    SDL_RWops *file;
    s_int8 ret = 0; 
...
s_int8 image::save (std::string fname) const
{
...
s_int8 image::save_raw (std::string fname) const
{
    ogzstream file (fname);
    s_int8 ret = 0; 
...
s_int8 image::save_pnm (std::string fname) const
{
    SDL_RWops *file;
    s_int8 ret = 0; 
