...
namespace gfx
{
    ...
    public:
         ...
         *  @sa get_raw ()
         */ 
        s_int8 load_raw (std::string fname);
         ...
         *  @sa get_pnm ()
         */ 
        s_int8 load_pnm (std::string fname); 
         ...
         *  @sa put ()
         */
        s_int8 save (std::string fname) const;
         ...
         *  @sa put_raw ()
         */
        s_int8 save_raw (std::string fname) const;
         ...
         *  @sa put_pnm ()
         */
        s_int8 save_pnm (std::string fname) const;
