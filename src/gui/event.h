...
namespace gui {
  ...
  class event
    ...
    public:
       ...
       * Default constructor
       */
      event(){return_code_=0;}

      /**
       * Define the return code when the object die
       */
	...
	{ callback_quit_ = func;}
      ...
      /**
       * Connect a python Signal
       * @param : a python function pointer
       * @param : the signal corresponding at an event
       * @param : A list of python args
       */
